...
const (
	PortsService_Upsert_FullMethodName    = "/PortsService/Upsert"
	PortsService_List_FullMethodName      = "/PortsService/List"
	PortsService_FindByKey_FullMethodName = "/PortsService/FindByKey"
)
...
func (c *portsServiceClient) Upsert(ctx context.Context, in *Port, opts ...grpc.CallOption) (*UpsertResponse, error) {
	...
	err := c.cc.Invoke(ctx, PortsService_Upsert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portsServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (PortsService_ListClient, error) {
	stream, err := c.cc.NewStream(ctx, &PortsService_ServiceDesc.Streams[0], PortsService_List_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *portsServiceClient) FindByKey(ctx context.Context, in *FindRequest, opts ...grpc.CallOption) (*FindResponse, error) {
	...
	err := c.cc.Invoke(ctx, PortsService_FindByKey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PortsService_Upsert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PortsService_Upsert_FullMethodName,
	}
...
func _PortsService_FindByKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PortsService_FindByKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
